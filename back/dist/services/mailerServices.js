...
export const sendWelcomeEmail = async (email, name) => {
    try {
        await sendMail(email, "Bienvenida a Renacer Consciente 🌿", `<h2>Hola ${name},</h2>
...
export const sendAppointmentConfirmationEmail = async (email, name, date, time) => {
    try {
        await sendMail(email, "Confirmación de turno 🌿", `<h2>Hola ${name},</h2>
...
export const sendCancellationEmail = async (email, name, date, time) => {
    try {
        await sendMail(email, "Cancelación de turno ❌", `<h2>Hola ${name},</h2>
